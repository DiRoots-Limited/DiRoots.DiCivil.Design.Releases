...
![DiRoots-Tips select rows](../../../assets/images/GIFs/PE/PE-Part-Swapping.gif)  
<sub>Note: the version on the image may not reflect the [latest version of DiCivil Package](https://diroots.com/civil-3d-plugins/dicivil/).</sub>
...
![DiRoots-Tips select rows](../../../assets/images/GIFs/PE/PE-Structure-Reference-Surface-Update.gif)  
<sub>Note: the version on the image may not reflect the [latest version of DiCivil Package](https://diroots.com/civil-3d-plugins/dicivil/).</sub>
